...
<?php
  ...
  print  "<title>DS-".$dados[4]["produto"]."</title>";
?>
</head>
...
<body>
  ...
  <main>
    <div class="text-start pt-5 ">
			<?php
				include_once("../dados/dados.php");
 				print  '<p class="display-5  text-start pt-3 ms-2">'.$dados[4]['produto'].'</p>';
			?>
    </div>
    <div class=" d-flex flex-column">

      <div class="d-flex flex-row">
        <img src="../images/mkt5.png" width="500px" class="rounded mx-auto d-block">
      </div>

      <div class="d-flex flex-row m-3">
        <?php
					include_once("../dados/dados.php");
					print  '<p>'.$dados[4]['descricao'].'</p>';
				?>
      ...
      <div class="mx-auto m-3">
        <div class="float-start">
          <img src="../images/mkt5.png" width="250px" class="rounded m-3">
          </div>
        <div class="float-start">
          <img src="../images/mkt5.png" width="250px" class="rounded m-3">
          </div>
      ...
      <?php
                include_once("../dados/dados.php");
                print  '<h2 class="mx-auto text-danger"> R$' . $dados[4]['preco'] . '</h2>';
